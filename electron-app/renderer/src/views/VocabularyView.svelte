<script lang="ts">
  ...
  async function addEntry() {
    ...
    try {
      await window.electronAPI.invoke('vocabulary_add_entry', { entry: newEntry });
  ...
  async function updateEntry() {
    ...
    try {
      await window.electronAPI.invoke('vocabulary_update_entry', { entry: editingEntry });
  ...
  async function deleteEntry(term: string) {
    ...
    try {
      await window.electronAPI.invoke('vocabulary_remove_entry', { term });
  ...
  async function toggleCategory(category: string, enabled: boolean) {
    try {
      await window.electronAPI.invoke('vocabulary_set_category_enabled', { category, enabled });
