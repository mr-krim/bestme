...
use plugin::transcribe::{
    SUPPORTED_LANGUAGES, update_whisper_params, get_whisper_params,
    add_vocabulary_entry, remove_vocabulary_entry, search_vocabulary,
...
// Import GPU commands
use gpu_commands::{get_gpu_info, is_gpu_enabled, get_available_gpu_backends, run_gpu_benchmark};
